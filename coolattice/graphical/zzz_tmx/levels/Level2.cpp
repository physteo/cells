...
namespace tmx {
	...
	Level2::Level2() : window{ "Physgood", 960, 540 },
	...
	void Level2::moveCamera()
	{
		camera.move();
	}

	void Level2::startPhysicsFrame()
	{
		particleWorld.startFrame();
	}

	void Level2::runPhysics(tmx::physics::real duration)
	{
		particleWorld.runPhysics(duration);
	}

	void Level2::sinchronizeGameComponents()
	{
		using namespace physics;
		using namespace graphics;
