...
class SMTYSpecsCoarseGrained : public PartSpecs
{
	// name
...
public:
	SMTYSpecsCoarseGrained();
	SMTYSpecsCoarseGrained(const Parameters* params, size_t divisionCycleLength, bool CIL, bool division);
...
private:
	SMTYSpecsCoarseGrained(double sigAA, double sigBB, double motility,
