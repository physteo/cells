...
class SMTYSpecsCoarseGrainedImproved : public PartSpecs
{
	// name
	const std::string specsName = "SMTY-Cycle-CoarseGrained";
...
public:
	SMTYSpecsCoarseGrainedImproved();
	SMTYSpecsCoarseGrainedImproved(const Parameters* params, size_t divisionCycleLength, bool CIL, bool division);
...
private:
	SMTYSpecsCoarseGrainedImproved(double sigAA, double sigBB, double motility,
