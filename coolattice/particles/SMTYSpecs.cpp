...
bool SMTYSpecs::cellIsDead(const Cell* cell, const Box* box)
{
	return false;
}


bool SMTYSpecs::cellDuplicates(Cell* cell, std::vector<Cell>* newCells, const Box* box, size_t& cellCounter, size_t cycleLength) const
{
