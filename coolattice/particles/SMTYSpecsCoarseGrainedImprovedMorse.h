...
class SMTYSpecsCoarseGrainedImprovedMorse : public PartSpecs
{
	// name
	const std::string specsName = "SMTY-Cycle-CoarseGrained-Improved-Morse";
...
public:
	SMTYSpecsCoarseGrainedImprovedMorse();
	SMTYSpecsCoarseGrainedImprovedMorse(const Parameters* params, size_t divisionCycleLength, bool CIL, bool division);
...
private:
	SMTYSpecsCoarseGrainedImprovedMorse(double sigAA, double sigBB, double motility,
